        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Servicios y Soluciones en Cómputo. Tu socio tecnológico de
              confianza desde 1999.
            </p>
            {/* Redes sociales */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="text-gray-400 hover:text-[#3498db] transition-colors text-sm"
                >
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <svg
                  ...
                  className="h-5 w-5 text-[#3498db] flex-shrink-0 mt-0.5"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="text-center items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Syscom. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
